...
## Scripting support
Please note that LGTV Companion also supports bidirectional communication and support for external scripting, as outlined <here>. This can be used in a lot of ways, to automate tasks and customise the behaviour of your WebOS-device.
...
Example: "LGTV Companion.exe" -poweron Device1 "OLED 42"
Explanation: Power on the device with id Device1 and the device named "OLED 42". Please note how the double quotes are used to escape the space (which is a control character) in the friendly device name.

Example: "LGTV Companion.exe" -poweroff
Explanation: Power off all configured devices
...
Example: "LGTV Companion.exe" -poweron Device1 -autodisable Device1
Explanation: Power on Device1 and then disable automatic management of Device1
...
Example: "LGTV Companion.exe" -sethdmi1 Device1 -sethdmi 2 Device2
Explanation: Set active HDMI-input to 1 for Device2 and then set active HDMI-input to 2 for Device2

Example: "LGTV Companion.exe" -set_input_type HDMI_1 pc PC Device1 -set_input_type HDMI_2 HDMI_2 "HDMI 2" Device2
Explanation: Set HDMI-input to PC-mode for Device1 and then set HDMI-input 2 to default for Device2

Example: "LGTV Companion.exe" -gamemode_hdmi1 on Device1
Explanation: Enable game optimiser for HDMI-input 1
...
Example: "LGTV Companion.exe" -mute Device1
Explanation: Mute Device1
...
Example: "LGTV Companion.exe" -button INFO device1
Explanation: Display the info-panel on device 1

Example: "LGTV Companion.exe" -button IN_START device1
Explanation: Display the service menu on device 1. Enter defautl code 0413 if you are certain you want to enter the srvice menu. Please use caution in the service menu!
...
Example: "LGTV Companion.exe" -picturemode normal device1 device2
Explanation: Set the picture mode to "Normal" for device1 and device2

Example: "LGTV Companion.exe" -contrast 80 device1
Explanation: Set contrast to 80 for device1

## Network settings
- *-wol* [true|false] 	- enable or disable the Wake-On-Lan setting, a k a "On with Mobile" or "Turn on via Wi-Fi"

Example: "LGTV Companion.exe" -wol true
Explanation: Set the wake-on-lan setting to ON for all devices

# Commands for sending generic requests to the device (for advanced users) 
...
Example: "LGTV Companion.exe" -request audio/volumeUp device1
Explanation: Increase volume one step for device1

Example: "LGTV Companion.exe" -request_with_params system.launcher/open {"target":"https://github.com/JPersson77/LGTVCompanion"} device1
Explanation: Open the built in web brower and go to the github page for this app on device 1

Example: "LGTV Companion.exe" -start_app com.webos.app.screensaver device1
Explanation: launch the screensaver on device1

Example: "LGTV Companion.exe" -close_app com.webos.app.screensaver device1
Explanation: close the screensaver on  device1
...
Example: "LGTV Companion.exe" -settings_picture {"realCinema":"on"} device1
Explanation: turn on Real Cinema for device1 

Example: "LGTV Companion.exe" -settings_picture {"color":"50","brightness":"50","contrast":"85"} device2
Explanation: set contrast to 50, brightness to 50 and contrast to 85 for device 2
...
Example: "LGTV Companion.exe" -settings_other {"blackStabilizer":13} device1
Explanation: Set black stabilizer to 13 for device1 
...
Example: "LGTV Companion.exe" -settings_options {"quickStartMode":"on"} device1
Explanation: Enable quickstart+ for device1 